...
enum class XYGpsBluetoothDeviceStayAwake(val state: Int) {
    Off(0),
    On(1)
}
...
//    }
    ...
    companion object : XYBase() {
        ...
        fun reportGlobalButtonPressed(device: XYGpsBluetoothDevice, state: XYFinderBluetoothDeviceButtonPress) {
