...
class PrimaryService(device: XYBluetoothDevice) : Service(device) {
    ...
    val buttonState = IntegerCharacteristic(this, Characteristics.ButtonState.uuid, "Button State")
    ...
    val lastError = IntegerCharacteristic(this, Characteristics.LastError.uuid, "Last Error")
    val uptime = IntegerCharacteristic(this, Characteristics.Uptime.uuid, "Uptime")
    val reset = IntegerCharacteristic(this, Characteristics.Reset.uuid, "Reset")
    val selfTest = IntegerCharacteristic(this, Characteristics.SelfTest.uuid, "Self Test")
    val debug = IntegerCharacteristic(this, Characteristics.Debug.uuid, "Debug")
    val leftBehind = IntegerCharacteristic(this, Characteristics.LeftBehind.uuid, "Left Behind")
